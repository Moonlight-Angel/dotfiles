# Generated by Powerlevel10k configuration wizard on 2019-08-25 at 12:48 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 61305.
# Wizard options: awesome-fontconfig + powerline, large icons, classic, darkest,
...
() {
  ...
  typeset -ga POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
      ...
      dir_writable            # if current directory is writable or not
      vcs                     # git status
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
      ...
      root_indicator          # if we are root or not
